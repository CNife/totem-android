...
static final int OPT_CREATE_ORIGINCLASS    = 1;
static final int OPT_CREATE_SELECTDEPUTY   = 2;
static final int OPT_DROP                  = 3;
static final int OPT_INSERT                = 4;
static final int OPT_DELETE                = 5;
static final int OPT_SELECT_DERECTSELECT   = 6;
static final int OPT_SELECT_INDERECTSELECT = 7;
  ...
  static final public String[] sql() throws ParseException {
    ...
    try {
      ...
      if (jj_2_1(3)) {
        ...
        drop_s = drop();
                     sql_s = drop_s;System.out.println(sql_s+"\u005cn");{if (true) return sql_s.split(",");}
      } else if (jj_2_3(3)) {
        select_s = select();
                        sql_s = select_s;System.out.println(sql_s+"\u005cn");{if (true) return sql_s.split(",");}
      } else if (jj_2_4(3)) {
        insert_s = insert2();
                         sql_s = insert_s;System.out.println(sql_s+"\u005cn");{if (true) return sql_s.split(",");}
      } else if (jj_2_5(3)) {
        delete_s = delete();
  ...
  static final public String drop() throws ParseException {
    ...
    try {
      ...
      cln = classname();
      jj_consume_token(SEMICOLON);
                                                  drop_s = OPT_DROP+","+cln;{if (true) return drop_s;}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("drop");
    }
  ...
  static final public int directselect() throws ParseException {
    ...
    try {
      ...
      jj_consume_token(WHERE);
      cond = condition();
                        st.add(cond);{if (true) return count;}
    throw new Error("Missing return statement in function");
    } finally {
